...
Finally we decided to implement a custom model to detect dynamic gestures similar to the one proposed by Yaseen et al.\cite{electronics13163233}, that consists on three layers: \textit{Mediapipe}, \textit{InceptionV3} and \textit{LSTM}.
...
MANCA LA DESCRIZIONE DELLA STRUTTURA DEL DATASET PER LE GESTURE DINAMICHE
