...
recognize hands and so frames are dropped, but vectors of the same size are required by the lstm. In this way
there was a big reduction of the whole dataset.
...
The last try was to \textbf{crop directly on the arms} detected by mediapipe....
-palo o chiattone
